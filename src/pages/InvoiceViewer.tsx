    ...
    <div className="flex-grow pt-24 pb-12 px-4 md:px-6  min-h-screen print:bg-white print:pt-0">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10 print:hidden">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-[#22D3EE]"
          >
            ← Back
          </button>
            ...
            <div className="sticky top-0 bg-white z-10 pb-6 mb-10 border-b border-gray-100 print:static print:border-none print:pb-0 print:mb-12">
              <div className="flex justify-between items-start gap-6">
                ...
                <div className="text-right flex flex-col items-end gap-2">
                  ...
                  <div
                    className={`px-3 py-1 text-[10px] font-bold border rounded ${getStatusStyles(invoice.status)}`}
                  >
                    {invoice.status}
                  </div>
                </div>
